export default {
  ...
  settings_units_view: 'Просмотр справочника единиц измерения',
  settings_units_manage: 'Управление пользовательскими единицами измерения',
  ...
  unitsSettings: 'Единицы измерения',
  ...
  contractLifecycleStatus: 'Статус контракта',
