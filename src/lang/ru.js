export default {
  ...
  settings_units_manage: 'Управление своими единицами и связями',
  ...
  unitsSettingsIntro: 'Системные единицы общие для всех и не редактируются. Свои единицы и связи задаются для текущей компании.',
  unitConversions: 'Связи',
  unitConversionsIntro: 'Одна родительская единица содержит указанное число дочерних (например 1 коробка = 24 бутылки). Обратная связь и циклы запрещены.',
  parentUnit: 'Вмещает (родитель)',
  childUnit: 'Содержится (дочерняя)',
  unitTypeSystem: 'Системная',
  unitTypeCustom: 'Своя',
  sideModalGenUnit: 'единицы измерения',
  sideModalNomUnit: 'Единица измерения',
  sideModalGenUnitConversion: 'связей',
  sideModalNomUnitConversion: 'Связь',
  ...
  unitConversionSuccessfullySaved: 'Связь сохранена',
  unitConversionSuccessfullyDeleted: 'Связь удалена',
  errorSavingUnitConversion: 'Не удалось сохранить связь',
  errorDeletingUnitConversion: 'Не удалось удалить связь',
  deleteUnitConversion: 'Удалить связь',
  errorLoadingUnitsPage: 'Не удалось загрузить справочник единиц',
  unitTabMain: 'Основное',
  unitPackagingAfterSave: 'Сохраните единицу, чтобы добавить связи.',
