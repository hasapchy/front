export default {
  ...
  standardRounding: 'Стандартное (математическое)',
  roundUp: 'Всегда вверх',
  roundDown: 'Всегда вниз',
  customThreshold: 'Кастомный порог',
  threshold: 'Порог',
  customThresholdHint: 'Например: 0.6 означает, что дробная часть >= 0.6 округляется вверх, < 0.6 - вниз',
  roundingRulesSaved: 'Правила округления сохранены',
  roundingRulesSavedSuccess: 'Все правила округления успешно применены к компании',
