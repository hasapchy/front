export default {
  ...
  unitsSettingsIntro: 'System units are shared and cannot be edited here. Custom units and links between units belong to the current company.',
  unitConversions: 'Links',
  unitConversionsIntro: 'One parent unit contains the given number of child units (for example 1 box = 24 bottles). Reverse links and cycles are not allowed.',
  parentUnit: 'Parent (contains)',
  childUnit: 'Child (inside)',
  unitTypeSystem: 'System',
  unitTypeCustom: 'Custom',
  sideModalGenUnit: 'unit of measure',
  sideModalNomUnit: 'Unit of measure',
  sideModalGenUnitConversion: 'link',
  sideModalNomUnitConversion: 'Link',
  ...
  unitConversionSuccessfullySaved: 'Link saved',
  unitConversionSuccessfullyDeleted: 'Link deleted',
  errorSavingUnitConversion: 'Could not save link',
  errorDeletingUnitConversion: 'Could not delete link',
  deleteUnitConversion: 'Delete link',
  errorLoadingUnitsPage: 'Could not load units catalog',
  unitTabMain: 'General',
  unitPackagingAfterSave: 'Save the unit first to add links.',
  ...
  // Order payment
    ...
    settings_units_manage: 'Manage custom units and links',
