export default {
  ...
  roundingThresholdHint: 'If fractional part >= threshold, round up, otherwise standard rounding',
  ...
  threshold: 'Threshold',
  customThresholdHint: 'Values below threshold round down, above - round up',
  roundingRulesSaved: 'Rounding Rules Saved',
  roundingRulesSavedSuccess: 'Rounding rules have been successfully saved',
