export default {
  ...
  warehouseAccounting: 'Warehouse accounting',
  finance: 'Finance',
  ...
  cashRegisterTypeCash: 'Cash register (cash)',
  cashRegisterTypeNonCash: 'Cash register (non-cash)',
  ...
  errorGettingProjectList: 'Error getting project list',
    ...
    stopRecurring: 'Stop',
    recurringStoppedSuccess: 'Recurring stopped',
