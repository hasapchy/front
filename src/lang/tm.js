export default {
  ...
  roundingThresholdHint: 'Dol belgisi >= begendeň, ýokary döw, ýok bolsa - mekdep döwülme',
  ...
  decimalPlaces: 'Belgi sany',
  roundingDirection: 'Döwülme ugry',
  standardRounding: 'Mekdep döwülme',
  roundUp: 'Uly tarapa döwmek',
  roundDown: 'Kiçi tarapa döwmek',
  customThreshold: 'Dile görä begenç',
  threshold: 'Begenç',
  customThresholdHint: 'Begencden pes - kiçi tarapa, ýokary - uly tarapa döwmek',
  roundingRulesSaved: 'Döwülme görkezmeleri saklandy',
  roundingRulesSavedSuccess: 'Döwülme görkezmeleri üstünlikli saklandy',
