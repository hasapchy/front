<template>
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 px-4 py-12">
        <div class="w-full max-w-md">
                ...
                <div class="px-8 py-10">
                    <form method="POST" action="/" @submit.prevent="login">
                        ...
                        <div class="mb-6">
                            ...
                            <input id="email" type="email" @input="clearErrors" :class="[
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input id="password" :type="showPassword ? 'text' : 'password'" @input="clearErrors"
                                    :class="[
                        ...
                        <div class="mb-6">
                            <div class="flex items-center">
                                <input
                                    ...
                                    type="checkbox" name="remember" id="remember" v-model="remember">
                        ...
                        <!-- Login Button -->
                        <PrimaryButton :onclick="login" :is-loading="loading" :is-info="true" :is-full="true"
            ...
            <div class="text-center mt-8 animate-fade-in-delay">
                <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg px-6 py-5 mb-4">
                    <div class="flex items-center justify-center mb-3">
                        <div class="w-12 h-12 flex items-center justify-center mr-3">
                            <img src="https://ltm.studio/assets/images/ltm.png" alt="Lebizli Tehnologiya Merkezi"
                        ...
                        <div class="text-left">
                            ...
                            <p
                                ...
                                Lebizli Tehnologiya Merkezi</p>
                        </div>
                    </div>

                    <div class="border-t border-gray-200 pt-3 mt-3 space-y-2">
                        <div
                            class="flex items-center justify-center text-sm text-gray-600 hover:text-blue-600 transition-colors">
                ...
                <p class="text-sm text-gray-600">
                    © 2025 Lebizli Tehnologiya Merkezi. Все права защищены
                </p>
            </div>
        </div>
    </div>
