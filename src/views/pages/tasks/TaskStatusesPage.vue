<template>
    ...
    <SideModalDialog :showForm="modalDialog" :onclose="handleModalClose">
        <TaskStatusCreatePage ref="taskstatuscreatepageForm" @saved="handleSaved" @saved-error="handleSavedError"
...
export default {
    ...
    components: {
        NotificationToast, PrimaryButton, SideModalDialog, TaskStatusCreatePage, Pagination, DraggableTable, AlertDialog, BatchButton, TableControlsBar, TableFilterButton, draggable: VueDraggableNext
    },
    data() {
        return {
    ...
    methods: {
        ...
        async fetchItems(page = 1, silent = false) {
            ...
            try {
                ...
                this.data = await TaskStatusController.getItems(page, per_page);
            } catch (error) {
