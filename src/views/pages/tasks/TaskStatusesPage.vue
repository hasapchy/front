...
export default {
    ...
    components: {
        PrimaryButton, SideModalDialog, TaskStatusCreatePage, Pagination, DraggableTable, AlertDialog, BatchButton, TableControlsBar, TableFilterButton, draggable: VueDraggableNext
    },
    data() {
        return {
