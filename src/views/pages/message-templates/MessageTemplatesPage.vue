    ...
    <div>
        <transition name="fade" mode="out-in">
            <div v-if="data != null && !loading" :key="`table-${$i18n.locale}`">
                <DraggableTable table-key="admin.message_templates" :columns-config="columnsConfig"
                    ...
                    <template #tableControlsBar="{ resetColumns, columns, toggleVisible, log }">
                        <TableControlsBar :show-pagination="true"
                            ...
                            <template #left>
                                <PrimaryButton v-if="canCreateTemplate" :onclick="() => { showModal(null) }"
                                    icon="fas fa-plus">
                                </PrimaryButton>
        ...
        <SideModalDialog :showForm="modalDialog" :onclose="handleModalClose">
            <MessageTemplateCreatePage :key="editingItem ? editingItem.id : 'new-template'" ref="templateCreatePageForm"
