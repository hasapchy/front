<template>
    <transition name="fade" mode="out-in">
        <div v-if="data != null && !loading" :key="`table-${$i18n.locale}`">
            <DraggableTable table-key="project_statuses" :columns-config="columnsConfig"
    ...
    <SideModalDialog :showForm="modalDialog" :onclose="handleModalClose">
        <ProjectStatusCreatePage ref="projectstatuscreatepageForm" @saved="handleSaved" @saved-error="handleSavedError"
...
export default {
    ...
    components: {
        NotificationToast, PrimaryButton, SideModalDialog, ProjectStatusCreatePage, Pagination, DraggableTable, AlertDialog, BatchButton, TableControlsBar, TableFilterButton, draggable: VueDraggableNext
    },
    data() {
        return {
