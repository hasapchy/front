    ...
    <div v-show="!collapsed" class="lg:!block">
      ...
      <div v-else-if="birthdays.length > 0" class="space-y-3">
        <div v-for="person in birthdays" :key="person.id"
          ...
          <div
            class="w-8 h-8 rounded-full overflow-hidden bg-gray-200 dark:bg-[var(--surface-muted)] flex items-center justify-center shrink-0 border border-gray-200 dark:border-white/10">
