<template>
  <button 
    :class="[
      ...
      isSoundEnabled 
        ? 'bg-[color-mix(in_srgb,var(--color-success)_18%,var(--surface-muted))] text-[var(--color-success)] hover:bg-[color-mix(in_srgb,var(--color-success)_28%,var(--surface-muted))]' 
