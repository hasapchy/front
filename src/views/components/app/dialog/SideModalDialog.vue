    ...
    <teleport to="body">
        <div :class="[
            ...
            <div class="fixed top-0 right-0 h-full flex transform transition-transform duration-300 ease-in-out z-50"
                ...
                <!-- Левая часть: форма -->
                <div id="form" class="h-full flex flex-col bg-white shadow-lg relative transition-all duration-300 ease-in-out" :style="{ width: modalWidth }">
                ...
                <div v-if="showTimelineButton" class="w-12 bg-gray-100 border-l border-gray-200 flex flex-col items-center justify-center transition-all duration-300 ease-in-out">
                ...
                <div class="transition-all duration-300 ease-in-out overflow-hidden" :style="{ width: timelineCollapsed ? '0px' : '420px' }">
                    <slot name="timeline" />
                </div>
            </div>
        </div>
...
<style scoped>
/* Плавная анимация для иконки в кнопке таймлайна */
.fas.fa-chevron-left,
...
/* Улучшенная анимация для основного контейнера */
