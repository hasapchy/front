<template>
    <aside class="w-40 bg-[#282E33] text-white flex-shrink-0 transform transition-transform duration-300">
        ...
        <div class="shrink-0 flex items-center p-4 justify-center">
            <a href="/">
                <svg width="313" height="77" viewBox="0 0 313 77" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="logoLet w-[50px] sm:w-[150px] md:w-[150px] lg:w-[150px] h-auto object-contain">
                    ...
                    <defs>
                        <clipPath id="clip0_7_43">
                            <rect width="312.19" height="76.1" fill="currentColor"></rect>
                        </clipPath>
                    </defs>
                </svg>
            </a>
