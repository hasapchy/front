    ...
    <aside class="w-40 bg-[#282E33] text-white flex-shrink-0 transform transition-transform duration-300">
        ...
        <div class="">
            ...
            <ul>
                ...
                <SidebarLink to="/orders" icon="fas fa-cart-arrow-down mr-2">
                    Заказы
                </SidebarLink>
                <SidebarLink to="/sales" icon="fas fa-shopping-cart mr-2">
                    Продажи 
                </SidebarLink>
                <SidebarLink to="/transactions" icon="fas fa-coins mr-2">
                    Финансы 
                </SidebarLink>
                <SidebarLink to="/clients" icon="fa-solid fa-user-friends mr-2">
                    Клиенты
                </SidebarLink>
                <SidebarLink to="/projects" icon="fa-solid fa-briefcase mr-2">
                    Проекты
                </SidebarLink>
