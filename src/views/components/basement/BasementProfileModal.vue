...
import BasementUsersController from '@/api/basement/BasementUsersController';
    ...
    methods: {
        ...
        async save() {
            ...
            try {
                ...
                const savedUser = await BasementUsersController.updateProfile(updateData, fileToUpload);
