...
export default class DriveController extends BaseController {
  ...
  static getFileIconClass(file) {
    ...
    const map = {
      ...
      txt: "fas fa-file-lines text-[var(--text-secondary)]",
      md: "fas fa-file-lines text-[var(--text-secondary)]",
      ...
      jpg: "fas fa-file-image text-[#A855F7]",
      jpeg: "fas fa-file-image text-[#A855F7]",
      png: "fas fa-file-image text-[#A855F7]",
      gif: "fas fa-file-image text-[#A855F7]",
      webp: "fas fa-file-image text-[#A855F7]",
      bmp: "fas fa-file-image text-[#A855F7]",
      svg: "fas fa-file-image text-[#A855F7]",
    };
