...
export default class CompaniesController extends BaseController {
  ...
  static async storeItem(item, logoFile) {
    const booleanFields = ['show_deleted_transactions', 'rounding_enabled', 'rounding_orders_enabled', 'rounding_contracts_enabled', 'rounding_quantity_enabled', 'skip_project_order_balance'];
