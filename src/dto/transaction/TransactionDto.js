...
export default class TransactionDto {
    constructor(id, type, isTransfer, cashId, cashName, cashAmount, cashCurrencyId, cashCurrencyName, cashCurrencyCode, cashCurrencySymbol, origAmount, origCurrencyId, origCurrencyName, origCurrencyCode, origCurrencySymbol, userId, userName, categoryId, categoryName, categoryType, projectId, projectName, clientId, client = null, note = '', date = '', createdAt = '', updatedAt = '') {
        this.id = id;
        this.type = type;
    ...
    typeCell() {
        return this.isTransfer === 1 ? '<i class="fas fa-right-left text-[#337AB7] mr-2"></i> Трансфер' : this.type === 1 ? '<i class="fas fa-circle-down text-[#5CB85C] mr-2"></i> Приход' : '<i class="fas fa-circle-up text-[#EE4F47] mr-2"></i> Расход';
    }
